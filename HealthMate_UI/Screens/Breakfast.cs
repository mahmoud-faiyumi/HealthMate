...
namespace HealthMate_UI.Screens
{
    public partial class Breakfast : Form
    {
        ...
        {
            if (!double.TryParse(BrkFstCal.Text, out double breakfastCal) && CheckBox1.Checked)
            {
            ...
            {
                UpdateBreakfastCalories(breakfastCal);
            }
        ...
        private void UpdateBreakfastCalories(double breakfastCal)
        {
            try
            {
                using (DatabaseManageruc databaseManageruc = new DatabaseManageruc())
                {
                    ...
                    {
                        updateCommand.Parameters.AddWithValue("@BreakfastCal", breakfastCal);
        ...
        private void CalculateAndStoreCalories(float portionVal)
        {
            try
            {
                ...
                if (selectedFood != null)
                {
                    ...
                    UpdateBreakfastCalories(portionCal);
                }
                else
                {
