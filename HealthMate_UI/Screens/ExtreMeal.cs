...
namespace HealthMate_UI.Screens
{
    public partial class ExtraMeal : Form
    {
        ...
        private void ExtraMeal_Load(object sender, EventArgs e)
        {
        ...
        {
            if (!double.TryParse(ExtraMealCal.Text, out double extraMealCal) && CheckBox1.Checked)
            {
            ...
            {
                UpdateExtraMealCalories(extraMealCal);
            }
        ...
        private void UpdateExtraMealCalories(double extraMealCal)
        {
            try
            {
                using (DatabaseManageruc databaseManageruc = new DatabaseManageruc())
                {
                    ...
                    {
                        updateCommand.Parameters.AddWithValue("@ExtraCal", extraMealCal);
        ...
        private void CalculateAndStoreCalories(float portionVal)
        {
            try
            {
                ...
                if (selectedFood != null)
                {
                    ...
                    UpdateExtraMealCalories(portionCal);
                }
                else
                {
