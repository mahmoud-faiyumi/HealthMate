...
namespace HealthMate_UI.Screens
{
    public partial class Lunch : Form
    {
        ...
        {
            if (!double.TryParse(LunchCal.Text, out double lunchCal) && CheckBox1.Checked)
            {
        ...
        private void UpdateLunchCalories(double lunchCal)
        {
            try
            {
                using (DatabaseManageruc databaseManageruc = new DatabaseManageruc())
                {
                    ...
                    {
                        updateCommand.Parameters.AddWithValue("@LunchCal", lunchCal);
        ...
        private void CalculateAndStoreCalories(float portionVal)
        {
            try
            {
                ...
                if (selectedFood != null)
                {
                    ...
                    UpdateLunchCalories(portionCal);
                }
                else
                {
